...
namespace FinalProject
{
    public partial class Tickets : Form
    {
        ...
        private void ticket_Count()
        {
            ...
            string sqlQuery = "SELECT COUNT(*) FROM e_ticket WHERE showtime_id = " + foundMovie[moviesListBox.SelectedIndex].ShowTime[showtimesListBox.SelectedIndex].Id + ";";
